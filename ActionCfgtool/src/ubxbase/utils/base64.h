...
#define BASE64_LEN(n)    (((n) * 4 + 2) / 3)
        ...
        UTILS_EXPORTS extern const base64_t std_base64;
        /*  ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_=  */
        UTILS_EXPORTS extern const base64_t url_base64;
         ...
         */
        UTILS_EXPORTS int base64_init(base64_t *b64, const char *alphabet);
        /* Return the number of characters placed in out.
         */
        UTILS_EXPORTS size_t base64_encode(const base64_t *b64, char *out, const void *in, size_t len, int flag);

        /* Return the number of characters placed in out.
         * On error, return a negative number, the absolute value of the number
         * equals to the consumed size of the input string.
         */
        UTILS_EXPORTS size_t base64_decode(const base64_t *b64, void *out, const char *in, size_t len, int flag);
#ifdef __cplusplus
    }
#endif
