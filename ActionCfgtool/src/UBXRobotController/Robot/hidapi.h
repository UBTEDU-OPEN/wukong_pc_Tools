...
#if 0
      //设备到达消息回调
      typedef void (*PHID_DEVICE_ARRIVAL_CALLBACK)(void *context, IOReturn result, void *sender,
                                                   IOHIDReportType report_type, uint32_t report_id,
                                                   uint8_t *report, CFIndex report_length);

      //设备移除消息回调
      typedef void (*PHID_DEVICE_REMOVAL_CALLBACK)(void *context, IOReturn result, void *sender);
#endif
#endif
