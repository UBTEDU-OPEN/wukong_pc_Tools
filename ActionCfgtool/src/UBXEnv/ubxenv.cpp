...
IMPL_SINGLETON_CLASS(UBXEnv);

UBXEnv::UBXEnv() : m_pClient(nullptr)
{
...
* 作者:   Leo
*/
QString UBXEnv::formatVersionStr(const QString & in)
{
    if (in.isEmpty()) {
        return "";
    }
...
* 作者:   Leo
*/
bool UBXEnv::isUpgrading(const QString & qsNativeVersion, const QString & qsRemoteVersion)
{
...
* 作者:   Leo
*/
bool UBXEnv::upgradingVersionXmlFile(const QString &qsXmlFullPath, VERSIONINFO *pInfo)
{
    ...
    UBXEnv::instance()->parseServerVersionXmlFile("E:\\Alpha2\\Alpha2_QT_Mini\\AlphaRobot2\\AlphaRobot\\Win32\\Debug\\Config\\AutoUpdater.xml", &m_remoteInfo);
}
...
* 作者:   Leo
*/
bool UBXEnv::parseServerVersionXmlFile(const QString &qsXmlPath, VERSIONINFO *pInfo)
{
    if (pInfo == nullptr) {
        return false;
    }
...
* 作者:   Leo
*/
bool UBXEnv::checkUpgradeAvailable()
{
...
* 作者:   Leo
*/
bool UBXEnv::calculatingPatch(const VERSIONINFO *native, const VERSIONINFO *remote, vector<ProgramFileInfo>& patch)
{
    patch.clear();
...
* 作者:   Leo
*/
map<QString, ProgramFileInfo> UBXEnv::parseRemoteVersionInfo(const QString &qsXmlPath)
{
...
* 作者:   Leo
*/
map<QString, ProgramFileInfo> UBXEnv::localFileList()
{
    const QString qsBaseDir = CConfigs::getAppBasicDataDir();
...
* 作者:   Leo
*/
QString UBXEnv::getRemoteVersion()
{
    return "";
}
