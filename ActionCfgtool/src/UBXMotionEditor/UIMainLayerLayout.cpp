...
void CUIMainLayerLayout::LayerManager_StopLayerDebug()
{
    if (m_pUILayerManager)
    {
        ...
        m_pUILayerManager->StopTotalLayerDebug();
    }
}
...
void CUIMainLayerLayout::LayerManager_SwitchActionLayer(emActionLayerType eActionType)
{
    if (m_pUILayerManager)
    {
        m_pUILayerManager->IUILayerManager_SwitchLayer(eActionType);
    }
}