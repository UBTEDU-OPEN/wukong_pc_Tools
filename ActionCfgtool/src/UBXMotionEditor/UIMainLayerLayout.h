...
class MOTIONEDITOR_EXPORT CUIMainLayerLayout : public QWidget, public ILayerManager, public IUILayerManager_Event/*, public ILayoutTools_Event *///20160519万向峰合并代码时注释掉
{
    Q_OBJECT
