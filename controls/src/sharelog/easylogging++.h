...
class Writer : base::NoCopy {
 public:
  ...
  ELPP_EXPORT Writer& construct(Logger* logger, bool needLock = true);
  ELPP_EXPORT Writer& construct(int count, const char* loggerIds, ...);
 protected:
  LogMessage* m_msg;
  Level m_level;
  const char* m_file;
  ...
  void ELPP_EXPORT processDispatch();
